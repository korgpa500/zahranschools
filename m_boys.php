    ...
    <body>
        ...
        <div id="home">
            <div id="myCarousel" class="carousel slide" data-ride="carousel">
                <div class="carousel-inner" role="listbox">
                    <div class="active">
                        <img src="image/mboys.jpg" alt="Middle Boys">
                        <div class="carousel-caption">
                            <img src="image/Logot.png" id="logoT">
                            <h2 class="textTitleYY">Middle School Boys</h2>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div id="mySidenav" class="sidenav">
                ...
                <a href="activelearn.php" id="ActiveLearn">Active Learning</a>
        ...
        <div id="aboutSec">
            <div class="containerY text-center">
                <h2 class="textTitleY" >ZAHRAN MIDDLE SCHOOL BOYS</h2>
        ...
        <?php
        $sqlAct = "SELECT * FROM activites WHERE sectionid=3 GROUP BY title";
            ...
            <div class="tz-gallery">
                <div class="row">
                    ...
                    while ($rowAct = $resAct->fetch_assoc()) {
                        ...
                        echo "<div class='row'>";
                        $sqlPic = "SELECT * FROM activites WHERE sectionid=3 AND title='" . $rowAct['title'] . "'";
                ...
                <div class="row">
                    <div class="col-sm-6">
                        ...
                        <form action="" method="post">
                            ...
                            <div class="form-group">
                                <input type="hidden" name="sectionMsg" value="3">
