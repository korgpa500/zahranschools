    ...
    <body>
        ...
        <div id="home">
            <div id="myCarousel" class="carousel slide" data-ride="carousel">
                <div class="carousel-inner" role="listbox">
                    <div class="active">
                        <img src="image/mgirl.JPG" alt="Middle Girls">
                        <div class="carousel-caption">
                            <img src="image/Logot.png" id="logoT">
                            <h2 class="textTitleYY">Middle School Girls</h2>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div id="aboutSec">
            <div class="containerY text-center">
                <h2 class="textTitleY" >ZAHRAN MIDDLE SCHOOL GIRLS</h2>
        ...
        <?php
        $sqlAct = "SELECT * FROM activites WHERE sectionid=6 GROUP BY title";
            ...
            <div class="tz-gallery">
                <div class="row">
                    ...
                    while ($rowAct = $resAct->fetch_assoc()) {
                        ...
                        echo "<div class='row'>";
                        $sqlPic = "SELECT * FROM activites WHERE sectionid=6 AND title='" . $rowAct['title'] . "'";
                ...
                <div class="row">
                    <div class="col-sm-6">
                        ...
                        <form action="" method="post">
                            ...
                            <div class="form-group">
                                <input type="hidden" name="sectionMsg" value="6">
                    ...
                    <div class="col-sm-6">
                        ...
                        <h3>Email : zahran.middlegirls@windowslive.com</h3>
                    </div>
                </div>
