    ...
    <body>
        ...
        <div id="home">
            <div id="myCarousel" class="carousel slide" data-ride="carousel">
                <div class="carousel-inner" role="listbox">
                    <div class="active">
                        <img src="image/kg.png" alt="Junior PICS">
                        <div class="carousel-caption">
                            <img src="image/Logot.png" id="logoT">
                            <h2 class="textTitleYY">Kindergarten</h2>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div id="aboutSec">
            <div class="containerY text-center">
                <h2 class="textTitleY" >ZAHRAN K.G</h2>
                <h2 class="textTitleY">ABOUT</h2>
                <h4>Kindergarten Mohammed Zahran name frequented every tongue of children's lives have a different form of the game is the basis of education and smile and fun are the beginning and end of the day</h4>
                <br>
                <h4>Kindergarten</h4>
            ...
            <div class="container text-center">
                ...
                <h4>
                    <ol>
                        ...
                        <li>Developing the talents of our children through participation in competitions and various activities</li>
        ...
        <?php
        $sqlAct = "SELECT * FROM activites WHERE sectionid=1 GROUP BY title";
            ...
            <div class="tz-gallery">
                <div class="row">
                    ...
                    while ($rowAct = $resAct->fetch_assoc()) {
                        ...
                        echo "<div class='row'>";
                        $sqlPic = "SELECT * FROM activites WHERE sectionid=1 AND title='" . $rowAct['title'] . "'";
                ...
                <div class="row">
                    <div class="col-sm-6">
                        ...
                        <form action="" method="post">
                            ...
                            <div class="form-group">
                                <input type="hidden" name="sectionMsg" value="1">
